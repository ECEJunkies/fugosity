    ...
    const char *file, int line)
{
    ...
    /* The following two lines fix a pcre_info() call break. I did not write
     * them, They came from an unnamed patch, but they're super short annd
     * simple so they probably wouldn't look any different anyways. If somebody
     * would let me know who originally fixed this, I will be glad to give them
     * full credit:
     */
    int v;
    pcre_fullinfo( ri->re, NULL, PCRE_INFO_CAPTURECOUNT, &v );
